...
let TestAVLLeftRotation () =
    ...
    let treeAfterRotation = T(T(T(E, 40, E), 50, T(E, 52, E)), 55, T(E, 60, T(E, 70, E)))
...
let TestAVLRightRotation () =
    ...
    let treeAfterRotation = T(T(T(E, 30, E), 40, E), 45, T(T(E, 47, E), 50, T(E, 60, E)))
...
let TestMap () =
    let tree = T(T(T(E, 4, E), 1, T(E, 13, E)), 20, T(T(E, 18, E), 9, T(E, 7, E)))
    let f = (*) 2
    let treeAfterMap = T(T(T(E, 8, E), 2, T(E, 26, E)), 40, T(T(E, 36, E), 18, T(E, 14, E)))
...
let TestConcat () =
    ...
    let treeAfterConcat = T(T(T(E, 1, E), 2, E), 3, T(T(T(E, 3, E), 4, E), 5, T(E, 6, E)))
